<script lang="ts">
	...
	export let siteLinkClass =
		'flex flex-col items-center justify-center mb-8 text-2xl font-semibold lg:mb-10 dark:text-white';
	export let siteImgClass = 'h-16';
	...
	<div class={mainDivClass}>
		...
		<Card class="w-full" size="md" border={false}>
			...
			<form class="mt-8 space-y-6" on:submit|preventDefault>
				...
				{/if}
				<Button class="bg-slate-600" type="submit" size="lg">{loginTitle}</Button>
				{#if createAccount}
