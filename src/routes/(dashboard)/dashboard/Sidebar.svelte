<script lang="ts">
	...
	import CreditCardSolid from 'flowbite-svelte-icons/CreditCardSolid.svelte';
	...
	let posts = [
		...
		},
		{
			...
			children: {
				...
				'Add User': '/dashboard/users/create-user',
				'Reset password': '/dashboard/users/reset-password',
		...
		// { name: 'Settings', icon: CogOutline, href: '/dashboard/settings' },
		{
			name: 'Message',
			icon: FileChartBarSolid,
			children: {
				'Send SMS': '/dashboard/sms/send-sms',
				'Check Balance': '/dashboard/sms/check-balance'
			}
		}
	];
